...
X_train.columns = "c_" + X_train.columns.astype(str) 
...
with mlflow.start_run(run_name='E2E_untuned_random_forest'):
  ...
  mlflow.spark.log_model("random_forest_model", python_model=wrappedModel, conda_env=conda_env, signature=signature)
...
table_path = "dbfs:/home/tnk6/delta/test_data"
...
#spark_df.write.format("delta").saveAsTable("tnk6_premier_demo.E2E_test_dataset")
